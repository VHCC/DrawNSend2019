...
import ichen.chu.hoverlibs.view.InViewDragger;
import ichen.chu.hoverlibs.window.InWindowDragger;
import ichen.chu.hoverlibs.window.WindowViewController;

import static ichen.chu.hoverlibs.SideDock.SidePosition.LEFT;
