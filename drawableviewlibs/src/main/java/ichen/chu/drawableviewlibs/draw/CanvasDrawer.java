package ichen.chu.drawableviewlibs.draw;

import android.graphics.Canvas;
import android.graphics.Paint;
import android.graphics.RectF;

import ichen.chu.drawableviewlibs.BuildConfig;
import ichen.chu.drawableviewlibs.DrawableViewConfig;
import ichen.chu.drawableviewlibs.draw.log.CanvasLogger;
import ichen.chu.drawableviewlibs.draw.log.DebugCanvasLogger;
import ichen.chu.drawableviewlibs.draw.log.NullCanvasLogger;

import static ichen.chu.drawableviewlibs.DrawableView.DEBUG_MODE;
